...
class _$AddressDataModelImpl implements _AddressDataModel {
  ...
  @override
  String toString() {
    return 'AddressDataModel(addressType: $addressType, city: $city, countryCode: $countryCode, countryName: $countryName, description: $description, email: $email, firstName: $firstName, id: $id, isDefault: $isDefault, key: $key, lastName: $lastName, line1: $line1, line2: $line2, middleName: $middleName, name: $name, organization: $organization, outerId: $outerId, phone: $phone, postalCode: $postalCode, regionId: $regionId, regionName: $regionName, zip: $zip)';
  }
...
abstract class _AddressDataModel implements AddressDataModel {
  factory _AddressDataModel(
      {@JsonKey(name: 'addressType') final int? addressType,
      ...
      @JsonKey(name: 'zip') final String? zip}) = _$AddressDataModelImpl;
