...
mixin _$TOTProduct {
  ...
  String? get name => throw _privateConstructorUsedError; // @HiveField(0)
  ...
  int? get maxQuantity => throw _privateConstructorUsedError; // @HiveField(1)
  ...
  set excludedProperties(List<ExcluededProperties>? value) =>
      throw _privateConstructorUsedError; // @HiveField(2)
  String? get imgSrc => throw _privateConstructorUsedError; // @HiveField(2)
  ...
  List<ProductLink>? get links => throw _privateConstructorUsedError;
  set links(List<ProductLink>? value) => throw _privateConstructorUsedError;
  ...
  set modifiedBy(String? value) =>
      throw _privateConstructorUsedError; // @HiveField(3)
  String? get id => throw _privateConstructorUsedError; // @HiveField(3)
...
abstract class _TOTProduct implements TOTProduct {
  ...
  int? get maxQuantity; // @HiveField(1)
  ...
  @override
  List<ProductLink>? get links;
  set links(List<ProductLink>? value);
  @override
...
class _$ProductLinkImpl implements _ProductLink {
  const _$ProductLinkImpl({this.type, this.url});
  ...
  @override
  String toString() {
    return 'ProductLink(type: $type, url: $url)';
  }
...
abstract class _ProductLink implements ProductLink {
  const factory _ProductLink({final String? type, final String? url}) =
      _$ProductLinkImpl;
