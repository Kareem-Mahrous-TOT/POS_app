...
_$_TOTCustomersModel _$$_TOTCustomersModelFromJson(Map<String, dynamic> json) =>
    _$_TOTCustomersModel(
...
Map<String, dynamic> _$$_TOTCustomersModelToJson(
        _$_TOTCustomersModel instance) =>
    <String, dynamic>{
