...
TOTAddCustomerModelResponse _$TOTAddCustomerModelResponseFromJson(
    Map<String, dynamic> json) {
  return _TOTAddCustomerModelResponse.fromJson(json);
}

/// @nodoc
mixin _$TOTAddCustomerModelResponse {
  ...
  @JsonKey(ignore: true)
  $TOTAddCustomerModelResponseCopyWith<TOTAddCustomerModelResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TOTAddCustomerModelResponseCopyWith<$Res> {
  factory $TOTAddCustomerModelResponseCopyWith(
          TOTAddCustomerModelResponse value,
          $Res Function(TOTAddCustomerModelResponse) then) =
      _$TOTAddCustomerModelResponseCopyWithImpl<$Res,
          TOTAddCustomerModelResponse>;
  @useResult
  $Res call(
      {String? name,
      String? memberType,
...
/// @nodoc
class _$TOTAddCustomerModelResponseCopyWithImpl<$Res,
        $Val extends TOTAddCustomerModelResponse>
    implements $TOTAddCustomerModelResponseCopyWith<$Res> {
  _$TOTAddCustomerModelResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$TOTAddCustomerModelResponseImplCopyWith<$Res>
    implements $TOTAddCustomerModelResponseCopyWith<$Res> {
  factory _$$TOTAddCustomerModelResponseImplCopyWith(
          _$TOTAddCustomerModelResponseImpl value,
          $Res Function(_$TOTAddCustomerModelResponseImpl) then) =
      __$$TOTAddCustomerModelResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? name,
...
/// @nodoc
class __$$TOTAddCustomerModelResponseImplCopyWithImpl<$Res>
    extends _$TOTAddCustomerModelResponseCopyWithImpl<$Res,
        _$TOTAddCustomerModelResponseImpl>
    implements _$$TOTAddCustomerModelResponseImplCopyWith<$Res> {
  __$$TOTAddCustomerModelResponseImplCopyWithImpl(
      _$TOTAddCustomerModelResponseImpl _value,
      $Res Function(_$TOTAddCustomerModelResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$TOTAddCustomerModelResponseImpl(
      name: freezed == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$TOTAddCustomerModelResponseImpl
    implements _TOTAddCustomerModelResponse {
  const _$TOTAddCustomerModelResponseImpl(
      {this.name,
      this.memberType,
      this.outerId,
      this.status,
  ...
  factory _$TOTAddCustomerModelResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$TOTAddCustomerModelResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'TOTAddCustomerModelResponse(name: $name, memberType: $memberType, outerId: $outerId, status: $status, addresses: $addresses, phones: $phones, emails: $emails, notes: $notes, groups: $groups, iconUrl: $iconUrl, dynamicProperties: $dynamicProperties, seoObjectType: $seoObjectType, seoInfos: $seoInfos, createdDate: $createdDate, modifiedDate: $modifiedDate, createdBy: $createdBy, modifiedBy: $modifiedBy, id: $id)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TOTAddCustomerModelResponseImplCopyWith<_$TOTAddCustomerModelResponseImpl>
      get copyWith => __$$TOTAddCustomerModelResponseImplCopyWithImpl<
          _$TOTAddCustomerModelResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$TOTAddCustomerModelResponseImplToJson(
      this,
    );
  }
}

abstract class _TOTAddCustomerModelResponse
    implements TOTAddCustomerModelResponse {
  const factory _TOTAddCustomerModelResponse(
      {final String? name,
      final String? memberType,
      final String? outerId,
      final String? status,
      ...
      final String? createdBy,
      final String? modifiedBy,
      final String? id}) = _$TOTAddCustomerModelResponseImpl;

  factory _TOTAddCustomerModelResponse.fromJson(Map<String, dynamic> json) =
      _$TOTAddCustomerModelResponseImpl.fromJson;
