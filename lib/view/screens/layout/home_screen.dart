                              ...
                              success: (successState) {
                                ...
                                return TotPOSProductDetailsDialogOrganism(
                                  ...
                                  onAddToCart: (product, count) {
                                    ...
                                    //     name: "add_to_cart_new",
                                    //     valueToSum: product.masterVariation
                                    //             ?.price?.actual?.amount
                                    //             ?.toDouble() ??
                                    //         5.0,
                                    //     parameters: {
                                ...
                                return Padding(
                                  ...
                                  child: AlignedGridView.count(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        type: "Physical",
                                        currency: "EGP",
                                        price: ${product.variations?.first.price?.actual?.amount?.toDouble() ?? 5.0}""");
                                                      context
                                                          .read<BagBloc>()
                            ...
                            return TotBagOrganism<double>(
                              ...
                              onCheckout: () {
                                facebookAppEvents.logPurchase(
                                    amount: value.bagEntity.totalPrice,
                                    currency: "EGP",
                                    parameters: {
                                      "createdBy": value.bagEntity.createdBy
                                    });
