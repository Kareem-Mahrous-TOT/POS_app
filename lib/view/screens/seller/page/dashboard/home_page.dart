            ...
            children: [
                ...
                child: BlocConsumer<HomeBloc, HomeState>(
                  ...
                  builder: (context, state) {
                    return state.maybeMap(
                        ...
                        loadedData: (value) {
                          print("value of loaded data ${value.dropdownValue!}");
                          ...
                          return GridView.builder(
                            ...
                            itemBuilder: (context, index) => Padding(
                              ...
                              child: TOTPOSFoodCardItemMolecule(
                                  ...
                                  mealImage: value.products[index].imgSrc ==
                                          null
                                  ...
                                  mealDescription: value.products[index]
                                                  .minQuantity ==
                                              null ||
                                          value.products[index].minQuantity == 0
                                      ? "Out of stock"
                                      : "In stock",
                                  price:
              ...
              BlocConsumer<ProductsCubit, ProductsState>(
                listener: (context, state) => state.maybeMap(
                  ...
                  empty: (value) => ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Center(
                        child: Text(
